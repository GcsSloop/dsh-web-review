...
- install the plugin through the desktop shell's bundled runtime

## [1.0.2] - 2026-09-18

### Added

- **bridge:** deliver page messages through WebView2 on Windows

## [1.0.1] - 2026-09-18

### Internal

- record the upstream fork and the desktop-shell dependency
...
- note the upstream fork and desktop-shell dependency
...
[1.0.3]: https://github.com/GcsSloop/dsh-web-review/compare/v1.0.2...v1.0.3
[1.0.2]: https://github.com/GcsSloop/dsh-web-review/compare/v1.0.1...v1.0.2
[1.0.1]: https://github.com/GcsSloop/dsh-web-review/compare/v1.0.0...v1.0.1
