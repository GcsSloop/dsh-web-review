...
describe('renderChangelog', () => {
  it('writes the Keep a Changelog header and per-version compare links', () => {
    ...
    expect(out).toContain('[1.1.0]: https://github.com/GcsSloop/dsh-web-review/compare/v1.0.0...v1.1.0')
    expect(out).toContain('[1.0.0]: https://github.com/GcsSloop/dsh-web-review/commits/v1.0.0')
  })
})
